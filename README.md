...
Os objetivos traçados no início do projeto foram em grande parte atingidos de forma consistente: foi disponibilizada uma ferramenta intuitiva que permite reportar obstáculos urbanos de forma rápida e acessível, dando visibilidade a problemas críticos que impactam diretamente pessoas com mobilidade reduzida, grávidas, idosos ou cidadãos em recuperação temporária. O sistema organiza os dados de forma estruturada e geolocalizada, apoiando os serviços municipais na tomada de decisões, e fomenta a participação cívica e a consciencialização coletiva ao incentivar todos os cidadãos a colaborar. No entanto, algumas funcionalidades previstas, como os alertas de proximidade e o planeamento de rotas alternativas, embora tenham sido desenvolvidas e testadas no backend, não chegaram a ser integradas no frontend, ficando assim indisponíveis para o utilizador final nesta versão.
...
A nível técnico, foi possível consolidar boas práticas de desenvolvimento, trabalhar com APIs REST, aplicar conceitos de DTOs e repositórios em Spring Boot, e explorar a ligação entre backend e frontend. No frontend, foram desenvolvidas as principais interfaces da aplicação móvel, incluindo formulários de reporte, navegação entre ecrãs e integração do mapa interativo, com ligação ao backend via Retrofit para envio e receção de dados em tempo real. Estas aprendizagens reforçaram a importância da rastreabilidade, da documentação clara e da distinção entre lógica implementada no backend e funcionalidades efetivamente expostas ao utilizador, garantindo uma experiência intuitiva e acessível para o utilizador final.

Outro aspeto relevante foi a experiência de trabalho em equipa, que exigiu gestão de tempo, divisão de responsabilidades, coordenação e capacidade de resolver problemas de forma colaborativa. Estas competências, tão importantes quanto a componente técnica, reforçaram o caráter multidisciplinar do projeto e mostraram-nos a importância de alinhar diferentes perspetivas em torno de um objetivo comum.

Em suma, a WayCare não deve ser vista apenas como uma aplicação tecnológica, mas como uma ferramenta de transformação social. Ao unir inovação, empatia e responsabilidade coletiva, o projeto contribui para a construção de cidades mais humanas, inclusivas e seguras, onde todos têm o direito de se mover com dignidade. Ao mesmo tempo, representa um marco académico e técnico, consolidando aprendizagens práticas que vão desde a programação e integração de sistemas até à comunicação e documentação, preparando-nos para enfrentar desafios futuros com maior professionalismo e rigor.
