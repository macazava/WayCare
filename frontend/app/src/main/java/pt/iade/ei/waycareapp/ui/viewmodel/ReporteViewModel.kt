...
class ReporteViewModel : ViewModel() {
    ...
    // Estado observável com StateFlow
                ...
                try {
                    val novoReporte = Reporte(
                        ...
                        rep_uti_id = Utilizador(
                            uti_id = 1,
                            uti_nome = "Maria",
                            uti_email = "maria123@gmail.com",
                            uti_password = "123"
                        ),
                        rep_ano_id = Anomalia(
                            ano_id = 2,
                            tip_id = TipoAnomalia(tip_id = 1, tip_nome = "buraco"),
                            ano_descricao = "Infraestrutura",
                        ...
                        rep_loc_id = Localizacao(
                            ...
                            loc_latitude = 38.7,
                            loc_longitude = -9.0,
                            loc_endereco = "Av. da liberdade 123"
                        ),
                        fotografia = Fotografia(
                            ...
                            foto_caminho = "caminho da foto",
                            foto_mime = "mime da foto",
                            foto_tamanho = 38
                        ),
                        rep_estado = "pendente",
                        rep_data = "2025-11-09",
